...
public class UserDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sw_antispam = (Switch) findViewById(R.id.switch_antispam);
    ...
    public void readUserData() {
        ...
        tw_UID.setText(UID);
        sw_antispam.setChecked(antispam);
    }
    ...
    public void saveUserData() {
        ...
        boolean antispam = sw_antispam.isChecked();
        ...
        editor.putBoolean("antispam", antispam);
        editor.commit();
